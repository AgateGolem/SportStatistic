    ...
    componentDidMount() {
        ...
        axios.get(`https://api.football-data.org/v2/competitions`, data)
            .then(response => {
                ...
                this.beginArray = response.data.competitions;
            })
            .catch((error) => {
                console.log(error);
            })
